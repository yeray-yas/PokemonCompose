package com.yerayyas.pokemoncompose.presentation.pokemon_list
...
import com.yerayyas.pokemoncompose.presentation.util.Constants.PAGE_SIZE
    ...
    fun loadPokemonPaginated() {
        viewModelScope.launch {
            ...
            val result = repository
                .getPokemonList(PAGE_SIZE, curPage * PAGE_SIZE)
            when (result) {
                is Resource.Success -> {
